...
import argparse
import cv2
def get_contours(binary, mode, method):
    ...
    if len(result) == 2:
        ...
        raise Exception("Unexpected findContours return format")
...
# (Contours work on binary images)
...
# Add some text
cv2.putText(test_shapes, "TEST SHAPES", (200, 390),
...
_, binary_shapes = cv2.threshold(gray_shapes, 127, 255,
cv2.THRESH_BINARY)
...
contours_external, _ = cv2.findContours(
    binary_shapes, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE)[1:]
# RETR_LIST: All contours
contours_list, _ = cv2.findContours(
    binary_shapes, cv2.RETR_LIST, cv2.CHAIN_APPROX_SIMPL)[1:]
# RETR_TREE: Full hierarchy
contours_tree, hierarchy_tree = cv2.findContours(
    binary_shapes, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)[1:]
...
cv2.putText(vis_external, f"RETR_EXTERNAL: {len(contours_external)}",(10, 30),
 cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)
cv2.putText(vis_list, f"RETR_LIST: {len(contours_list)}", (10, 30),
 cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)
cv2.putText(vis_tree, f"RETR_TREE: {len(contours_tree)}", (10, 30),
 cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)
...
contours_real, _ = cv2.findContours(
...
for i, contour in enumerate(contours_real):
    ...
    cv2.putText(vis, f"Contour {i+1}", (10, 30),
    cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 2)
...
for eps in epsilons:
 ...
 # Visualize
    ...
    cv2.putText(vis, f"Approx: {len(approx)} points", (10, 30),
    cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)
...
contours_nested, hierarchy_nested = cv2.findContours(
    binary_nested, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)[1:]
...
for i, contour in enumerate(contours_nested):
 ...
 # Label
    ...
    if M["m00"] != 0:
        ...
        cv2.putText(hier_vis, str(i), (cx-10, cy-10),
...
# Find contours
coin_contours, _ = cv2.findContours(
    binary_coins, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE)[1:]
...
# Title
cv2.putText(reference, "CONTOUR REFERENCE GUIDE", (ref_width//2 - 230,40),
...
contours_ex, _ = cv2.findContours(contour_example, cv2.RETR_EXTERNAL,
...
cv2.putText(reference, "cv2.contourArea(c) - Area of contour", (200,110),
 cv2.FONT_HERSHEY_SIMPLEX, 0.5, (200, 200, 200), 1)
cv2.putText(reference, "cv2.arcLength(c, True) - Perimeter", (200, 135),
 cv2.FONT_HERSHEY_SIMPLEX, 0.5, (200, 200, 200), 1)
cv2.putText(reference, "cv2.boundingRect(c) - Bounding box", (200,160),
 cv2.FONT_HERSHEY_SIMPLEX, 0.5, (200, 200, 200), 1)
cv2.putText(reference, "cv2.minEnclosingCircle() - Enclosing circle", (200, 185),
 cv2.FONT_HERSHEY_SIMPLEX, 0.5, (200, 200, 200), 1)
cv2.putText(reference, "cv2.moments(c) - Center calculation", (200, 210),
 cv2.FONT_HERSHEY_SIMPLEX, 0.5, (200, 200, 200), 1)
# Retrieval modes
cv2.putText(reference, "RETRIEVAL MODES:", (200, 250), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 0), 2)
cv2.putText(reference, "RETR_EXTERNAL - Only outer contours", (200,280),
 cv2.FONT_HERSHEY_SIMPLEX, 0.5, (200, 200, 200), 1)
cv2.putText(reference, "RETR_LIST - All contours, no hierarchy",(200, 305),
 cv2.FONT_HERSHEY_SIMPLEX, 0.5, (200, 200, 200), 1)
cv2.putText(reference, "RETR_TREE - Full hierarchy (nested)", (200, 330),
 cv2.FONT_HERSHEY_SIMPLEX, 0.5, (200, 200, 200), 1)
cv2.putText(reference, "RETR_COMP - Two-level hierarchy", (200, 355),
 cv2.FONT_HERSHEY_SIMPLEX, 0.5, (200, 200, 200), 1)
# Approximation methods
cv2.putText(reference, "APPROXIMATION:", (200, 395), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 0), 2)
cv2.putText(reference, "CHAIN_APPROX_SIMPLE - Compresses to endpoints",(200, 425),
 cv2.FONT_HERSHEY_SIMPLEX, 0.5, (200, 200, 200), 1)
cv2.putText(reference, "CHAIN_APPROX_NONE - All points", (200, 450),
 cv2.FONT_HERSHEY_SIMPLEX, 0.5, (200, 200, 200), 1)
# Shape detection guide
cv2.putText(reference, "SHAPE DETECTION (by vertices):", (200, 490),
 cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 0), 2)
cv2.putText(reference, "3 = Triangle, 4 = Square/Rectangle, 5+ = Polygon/Circle", (200, 520),
 cv2.FONT_HERSHEY_SIMPLEX, 0.5, (200, 200, 200), 1)
# OpenCV 3+ note
cv2.putText(reference, "OpenCV 3.0+ : image, contours, hierarchy = cv2.findContours()", (30, 580),
 cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 255), 1)
cv2.putText(reference, "Use [1:] to ignore first return value for compatibility", (30, 605),
 cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 255), 1)
cv2.putText(reference, "contours, hierarchy = cv2.findContours(...)[1:]",(30, 630),
 cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 255), 1)
