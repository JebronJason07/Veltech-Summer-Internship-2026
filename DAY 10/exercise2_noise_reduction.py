...
def noise_reduction_pipeline(image, noise_type="auto"):
    """
    Automatically choose the best blurring method based on noise type
    """
    ...
    if noise_type == "saltpepper":
        ...
        # Check if likely salt-pepper noise (many 0 or 255 values)
...
# Create test images with different noise
...
test_images = {
    ...
    "Mixed": add_gaussian(add_salt_pepper(gray, 0.02), 15)
}


# Apply pipeline to each
