...
for kernel_type in kernels:
    ...
    result, kernel = apply_custom_blur(gray, kernel_type, 7)
    ...
    # Show result
    cv2.imshow(f"Kernel: {kernel_type}", result)
    cv2.waitKey(0)

    # Also show kernel visualization
    ...
    kernel_vis = cv2.resize(kernel_vis, (200, 200))
